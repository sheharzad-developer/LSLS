...
import { BookOpen, Calendar, FileText, Users, GraduationCap } from "lucide-react"
...
export default async function TeacherDashboard() {
  ...
  const totalStudents = teacher?.classes.reduce((acc, tc) => acc + tc.class.students.length, 0) || 0
